package com.paymorecase.ui.utilty
...
@Preview(name = "Tablet - Small", device = "spec:width=600dp,height=960dp,dpi=320", showBackground = true, apiLevel = 34)
@Preview(name = "Tablet - Medium", device = "spec:width=800dp,height=1280dp,dpi=320", showBackground = true, apiLevel = 33)
@Preview(name = "Tablet - Large", device = "spec:width=1000dp,height=1600dp,dpi=320", showBackground = true, apiLevel = 32)
